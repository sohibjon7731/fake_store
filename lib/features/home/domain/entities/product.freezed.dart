...
class _$ProductEntityImpl implements _ProductEntity {
  ...
  @override
  String toString() {
    return 'ProductEntity(id: $id, title: $title, prize: $prize, description: $description, category: $category, image: $image)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, prize, description, category, image);
